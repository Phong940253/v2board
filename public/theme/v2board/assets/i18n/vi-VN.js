window.settings.i18n['vi-VN'] = {
  ...
  '该订阅长期有效': 'Gói này có thời hạn dài',
  '已过期': 'Hết hạn',
  '已用 {used} / 总计 {total}': 'Đã sử dụng {used} / tổng số {total}',
  '重置订阅信息': 'Đặt lại thông tin đăng ký',
  ...
  '确定': 'OK',
  '确定要重置订阅信息？': 'Bạn có chắc chắn muốn đặt lại thông tin đăng ký của mình không? ',
  '如果你的订阅地址或信息泄露可以进行此操作。重置后你的UUID及订阅将会变更，需要重新进行订阅。': 'Nếu địa chỉ hoặc thông tin gói dịch vụ của bạn bị tiết lộ có thể tiến hành thao tác này. Sau khi reset UUID sẽ thay đổi.',
  '重置成功': 'Reset thành công',
  '低': 'Thấp',
  '中': 'Vừa',
  ...
  '已用流量已在今日重置': 'Dữ liệu đã sử dụng đã được thiết lập lại ngày hôm nay',
  '重置已用流量': 'Đặt lại dữ liệu đã sử dụng',
  '查看节点状态': 'Xem trạng thái máy chủ',
  '当前已使用流量达{rate}%': 'Lưu lượng truy cập hiện được sử dụng đạt {rate}%',
  '节点名称': 'Tên máy chủ',
