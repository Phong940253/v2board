                ...
                <div style="background:#fff">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr style="padding:40px 40px 0 40px;display:table-cell">
                            <td style="font-size:24px;line-height:1.5;color:#000;margin-top:40px">Thông báo băng thông</td>
                        </tr>
                        <tr>
                            <td style="font-size:14px;color:#333;padding:24px 40px 0 40px">
                                ...
                                <br />
                                <br />
                                Lưu lượng truy cập của bạn đã được sử dụng 80%. Để không ảnh hưởng đến việc sử dụng, vui lòng bố trí sử dụng lưu lượng hợp lý.
                            </td>
                        </tr>
